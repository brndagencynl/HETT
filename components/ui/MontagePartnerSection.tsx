  ...
  return (
    <section className="py-12 md:py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12">
          ...
          <div className="lg:col-span-7 p-6 md:p-8 lg:p-10">
            ...
            <p className="text-gray-600 leading-relaxed mb-6 text-base">
              ...
              oplevering: u heeft één aanspreekpunt. Montage is uitsluitend beschikbaar op basis van een persoonlijke offerte.
            </p>
            ...
            <div className="inline-flex items-center gap-3 bg-gradient-to-r from-[#003878] to-[#002050] text-white px-5 py-3 rounded-xl mb-6 shadow-lg">
              ...
              <span className="text-lg font-bold">Montage op offerte</span>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
              ...
              <div className="mt-4 pt-4 border-t border-gray-100 lg:hidden">
                <div className="text-center">
                  <span className="text-xs text-gray-500 uppercase tracking-wide">Montage</span>
                  <p className="text-lg font-black text-[#003878]">Op offerte</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <p className="mt-4 text-xs text-gray-500 text-center md:text-left max-w-3xl">
        Montage is beschikbaar in heel Nederland. De prijs is afhankelijk van het type veranda, locatie en bereikbaarheid. 
        Vraag vrijblijvend een offerte aan via onze contactpagina of WhatsApp.
      </p>
    </section>
  );
};
