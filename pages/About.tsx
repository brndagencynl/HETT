      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-32">
            ...
            <div className="grid grid-cols-2 gap-4">
                <img src="https://picsum.photos/400/500?random=60" className="rounded-2xl w-full h-full object-cover shadow-lg transform translate-y-8" alt="Productie" />
                <img src="https://picsum.photos/400/500?random=61" className="rounded-2xl w-full h-full object-cover shadow-lg" alt="Montage" />
            </div>
        </div>
                                ...
                                >
                                    <div className="flex items-center gap-4">
                                        <div className={`w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 transition-colors ${
                                            isActive ? 'bg-hett-brown text-white' : 'text-hett-brown bg-white'
                                        }`}>
