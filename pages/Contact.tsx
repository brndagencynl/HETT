      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white p-8 rounded-md border border-gray-200 shadow-sm h-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          ...
          <div className="bg-hett-dark p-8 md:p-10 rounded-md text-white">
            ...
            <Link 
              to="/contact" 
              className="ds-btn ds-btn--ghost" style={{ borderColor: 'rgba(255,255,255,0.3)', color: '#fff', background: 'rgba(255,255,255,0.1)' }}
            >
          ...
          <div className="bg-gray-100 p-8 md:p-10 rounded-md border border-gray-200">
