      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <form className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input type="text" className="w-full px-5 py-4 border border-gray-200 rounded-lg focus:border-hett-brown focus:ring-1 focus:ring-hett-brown outline-none transition-all bg-gray-50 hover:bg-white" placeholder="Bijv. Jan" />
                </div>
                <div>
                  <label className="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">Achternaam</label>
                  <input type="text" className="w-full px-5 py-4 border border-gray-200 rounded-lg focus:border-hett-brown focus:ring-1 focus:ring-hett-brown outline-none transition-all bg-gray-50 hover:bg-white" placeholder="Bijv. Jansen" />
                </div>
              </div>

              <div>
                <label className="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">Bedrijfsnaam</label>
                <input type="text" className="w-full px-5 py-4 border border-gray-200 rounded-lg focus:border-hett-brown focus:ring-1 focus:ring-hett-brown outline-none transition-all bg-gray-50 hover:bg-white" placeholder="Optioneel" />
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">E-mailadres</label>
                  <input type="email" className="w-full px-5 py-4 border border-gray-200 rounded-lg focus:border-hett-brown focus:ring-1 focus:ring-hett-brown outline-none transition-all bg-gray-50 hover:bg-white" placeholder="naam@bedrijf.nl" />
                </div>
                <div>
                  <label className="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">Telefoonnummer</label>
                  <input type="tel" className="w-full px-5 py-4 border border-gray-200 rounded-lg focus:border-hett-brown focus:ring-1 focus:ring-hett-brown outline-none transition-all bg-gray-50 hover:bg-white" placeholder="06 12345678" />
                </div>
              </div>

              <div>
                <label className="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">Uw bericht / Aanvraag</label>
                <textarea rows={5} className="w-full px-5 py-4 border border-gray-200 rounded-lg focus:border-hett-brown focus:ring-1 focus:ring-hett-brown outline-none transition-all bg-gray-50 hover:bg-white resize-none" placeholder="Waar kunnen we u mee helpen?"></textarea>
              </div>

              <button type="button" className="w-full bg-hett-dark text-white font-bold text-lg py-5 rounded-lg hover:bg-hett-brown transition-all shadow-lg transform hover:-translate-y-1">
                Verstuur Aanvraag
              </button>
            </form>
          </div>
          ...
          <div className="space-y-8">
            <div className="bg-white p-8 md:p-10 shadow-sm border border-gray-100 rounded-xl">
              ...
              <ul className="space-y-8">
                <li className="flex items-start gap-6">
                  <div className="w-14 h-14 bg-[#fdf6d3] text-hett-brown flex items-center justify-center rounded-lg flex-shrink-0">
                    <MapPin size={24} />
                  </div>
                  <div>
            ...
            <div className="h-80 bg-gray-200 rounded-xl overflow-hidden relative shadow-sm border border-gray-100 group">
               ...
               <div className="absolute inset-0 flex items-center justify-center">
                   <button className="bg-white px-8 py-4 rounded-lg shadow-xl font-bold text-hett-dark hover:bg-gray-50 transition-all hover:scale-105 flex items-center gap-2">
                       <MapPin size={20} />
                       Google Maps Openen
                   </button>
               </div>
